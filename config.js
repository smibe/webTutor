...
module.exports = {
  mongo: {
    ...
    apiKey: 'iuDOjCZDfPU4JKY9xNb7Q2tU-iMJ3GPO'                 // Our MongoLab API key
  },
  security: {
    dbName: 'angular-test',                                   // The name of database that contains the security information
  ...
  server: {
    ...
    cookieSecret: 'angular-gehapp'                         // The secret for encrypting the cookie
  }
};